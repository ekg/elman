...
- E28: E1 + Mamba2 conv (depthwise K=4)

Both at ~50M params, same architecture except for conv.
"""
...
OUTPUT_DIR = Path("/home/erikg/elman/benchmark_results/e28_vs_e1")
...
def main():
    print("=" * 70)
    print("E28 vs E1 Benchmark (10 minutes each)")
    print("=" * 70)
