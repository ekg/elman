#!/usr/bin/env python3
"""E10 sweep with low k values: 1, 2, 4, 8 banks."""
import os, subprocess, time, sys
sys.path.insert(0, '/home/erikg/elman')

TIME_LIMIT = 600
OUT = "benchmark_results/e10_lowk"
os.makedirs(OUT, exist_ok=True)

print("=" * 70)
print("E10 LOW-K SWEEP (k=1,2,4,8)")
print("=" * 70)
...
for k in [1, 2, 4, 8]:
    ...
    print(f"E10 k={k}: dim={dim}, depth=6, params={params:,}")

# Higher batch sizes for low-k (less memory per sample)
batch_sizes = {
    "e1": 256,
    "e10_k1": 256,
    "e10_k2": 224,
...
print("\n" + "=" * 70)
print(f"LAUNCHING {len(configs)} JOBS")
print("=" * 70)
