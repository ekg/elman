#!/usr/bin/env python3
"""
SAME STEPS comparison with SCHEDULE-FREE AdamW.
batch=16, 1500 steps for all.
"""
import subprocess
import os
...
print("=" * 70)
print(f"SAME STEPS + SCHEDULE-FREE (batch={BATCH_SIZE}, steps={NUM_STEPS})")
print("=" * 70)
...
print("\n" + "=" * 70)
print("RESULTS (Schedule-Free AdamW)")
print("=" * 70)
