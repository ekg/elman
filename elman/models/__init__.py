"""
Elman Ablation Ladder - Linear-Space Levels (0-6) and Log-Space Levels (log_0 to log_5)
...
Log-Space Ablation Ladder:
    ...
    log_5: Log-Space Triple R - R_h, R_x, R_delta for maximum expressivity
...
def get_ladder_level(level):
    ...
    if level not in levels:
        raise ValueError(f"Invalid level {level}. Must be 0-6 or log_0 to log_5.")
...
__all__ = [
    ...
    # Log-space level classes (log_0 to log_5)
