...
// Backward through output = h * silu(gate_raw)
...
__global__ void SelectiveOutputBackward(
    ...
    float* __restrict__ d_b_gate) {     // [dim] bias gradient
